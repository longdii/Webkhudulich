...
<body>
    ...
    <form action="http://localhost/WebKhuVuiChoi/PhoCo_admin_c/timkiem" method="post">
        <div class="header">
        ...
        <div class="container">
            ...
            <table class="content__table">
                ...
                <tr>
                    ...
                    <td>
                        <a href="http://localhost/WebKhuVuiChoi/PhoCo_admin_c/xoa/<?php echo $row['MaPhoCo'] ?>"><i
                                class="content__table-icon fa-solid fa-trash"></i></a>
                        &nbsp;&nbsp;&nbsp;
                        <a href="http://localhost/WebKhuVuiChoi/PhoCo_admin_c/sua/<?php echo $row['MaPhoCo'] ?>"><i
