...
<body>
    ...
    <h1 style="text-align: center">Trải nghiệm - Sun World Hạ Long</h1>
        <div  style="text-align: center" class="next-trainghiem">
           <a href="">Trang Chủ</a ><i class="ti-angle-right"></i>
            <a href="">Trải Nghiệm</a ><i class="ti-angle-right"></i>

        </div>
    </div>
    <div class="noidungtrainghiem">
      <div class="thongtin">
       <h1 style="text-align:center"><b>THẾ GIỚI GIẢI TRÍ CHO CẢ NHÀ</b></h1>
        <p style="margin-right:100px">Sun World Ha Long tạo nên một không gian giải trí hết sức thú vị, để người lớn, trẻ con và những người trẻ ham khám phá đều có thể tìm thấy niềm vui riêng của mình tại chốn này.</p>
        <img src="https://halong.sunworld.vn/wp-content/uploads/2018/10/Screen-Shot-2018-10-17-at-9.58.18-AM.png">
        ...
        <div class="form-trainghiem">
            ...
            <a href="">
            <img style="width:270px ;height:150px"src="https://halong.sunworld.vn/wp-content/uploads/2022/02/273843380_1630524240620092_7913707842327601108_n-270x170.jpg">
            <div class="title">Bảo Hải Linh Thông Tự</div>
        ...
        <div class="form-trainghiem">
            ...
            <a href="">
            <img style="width:270px ;height:150px"src="https://halong.sunworld.vn/wp-content/uploads/2018/10/17861745_1450815441659147_7614405696089232410_n.jpg">
            <div class="title">Bãi biển Sun World</div>
