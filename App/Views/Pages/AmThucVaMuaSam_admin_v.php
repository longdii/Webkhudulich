...
<body>
    ...
    <form action="http://localhost/WebKhuVuiChoi/AmThucVaMuaSam_admin_c/timkiem" method="post">
        <div class="header">
            ...
            <ul class="header-list">
                ...
                <li class="header-item">
                    <button class="header-btn" type="submit" name="btnThemAmThuc">Add</button>
                </li>
            </ul>
        </div>
        <div class="container">
            ...
            <table class="content__table">
                ...
                <tr>
                    ...
                    <td><div><?php echo $row['TenAmThuc'] ?></div></td>
                    <td><div><?php echo $row['DiaChiAmThuc'] ?></div></td>
                    <td><div class="summarize"><?php echo $row['MoTaAmThuc'] ?></div></td>
                    <td>
                        <a
                            href="http://localhost/WebKhuVuiChoi/AmThucVaMuaSam_admin_c/xoa/<?php echo $row['MaAmThuc'] ?>"><i
                                class="content__table-icon fa-solid fa-trash"></i></a>
                        &nbsp;&nbsp;&nbsp;
                        <a
                            href="http://localhost/WebKhuVuiChoi/AmThucVaMuaSam_admin_c/sua/<?php echo $row['MaAmThuc'] ?>"><i
