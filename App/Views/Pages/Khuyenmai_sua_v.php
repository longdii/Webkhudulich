...
<head>
    ...
    <link rel="stylesheet"
        href="/WebKhuVuiChoi/Public/Css/Public/Css/fonts/fontawesome-free-6.4.2-web/css/all.min.css">
...
<body>
    <form action="/WebKhuVuiChoi/TinKhuyenMai_admin/suadl" method="post">
        <div class="header">
