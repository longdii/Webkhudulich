...
<body>
    ...
    <form action="http://localhost/WebKhuVuiChoi/AmThucVaMuaSam_admin_c/themmoi" method="post">
        <div class="header">
            <ul class="header-list">
                <li class="header-item">
                    <span class="header-item-tile">
                        THÊM MỚI ẨM THỰC VÀ MUA SẮM
                    </span>
                </li>
            </ul>
            <ul class="header-list">
        ...
        <div class="container">
            <table class="content__table">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="content__table-input" id="txtTenAmThuc" name="txtTenAmThuc" value="">
                    </td>
                    <td>
                    ...
                    <td>
                        <input type="text" class="content__table-input" name="txtMoTaAmThuc" value="">
                    </td>
                </tr>
                <tr>
                    <td>
