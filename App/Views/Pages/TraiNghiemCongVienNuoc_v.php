...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/WebKhuVuiChoi/Public/Css/TraiNghiemCongVienNuoc.css">
        ...
        <div  style="text-align: center" class="next-congviennuoc">
           <a href="">Trang Chủ</a ><i class="ti-angle-right"></i>
            ...
            <div id="sub-trainghiem" class="sub-trainghiem">
               ...
               <a href="http://localhost/WebKhuVuiChoi/TraiNghiemHaiDang">+ Hải Đăng Sun World</a>
...
<?php
    ...
    <div class="col l-3">
        <div class="content_hop">
             <a href="">
           <div class="noidungcongviennuoc-img"><img src="http://localhost/webkhuvuichoi/Public/Images/<?php echo $row['AnhVe']?>"></div>
