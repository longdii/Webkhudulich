...
<head>
    ...
    <link rel="stylesheet" href="/WebKhuVuiChoi/Public/Css/TraiNghiemCongVienNuoc.css">
...
<body>
<div class="congviennuoc">
        <h1 style="text-align: center">Công Viên Nước - Sun World Hạ Long</h1>
        <div  style="text-align: center" class="next-congviennuoc">
           <a href="">Trang Chủ</a ><i class="ti-angle-right"></i>
            <a href="">Trải Nghiệm</a ><i class="ti-angle-right"></i>
            <a  id="cvnuoc" href="#">Công Viên Nước</a ><i class="ti-angle-down"></i>
            <div id="sub-trainghiem" class="sub-trainghiem">
               <a href="/WebKhuVuiChoi/TraiNghiemCongVienRong">+ Công Viên Rồng</a>
               ...
               <a href="/WebKhuVuiChoi/TraiNghiemCapTreoNuHoang">+ Cáp Treo Nữ Hoàng Và Khu Đồi Huyền Bí</a>
            </div>
             
           
</diV>
<div class="noidungcongviennuoc">
<div class="grid wide">
            <div class="row">
                <div class="content_cvn-right">
                    <span>Bộ lọc:</span> &nbsp;&nbsp;
...
<?php
    ...
    <div class="col l-3">
        <div class="content_hop">
             <a href="">
           <div class="noidungcongviennuoc-img"><img src="/webkhuvuichoi/Public/Images/<?php echo $row['AnhVe']?>"></div>
            <div class="title"><b><?php echo $row['TieuDe']?></b></div>
            <div class="content_date">
                            <span style="width: 100px; height: 70px">Công Viên Nước</span>
                            <span style="margin-left: 10px;">|</span>
                            <i class="ti-calendar"></i>
                            <span>20/02/2020</span>
                        </div>
            <p class="content"><?php echo $row['MoTa'] ?></p>
...
<script>
    i=0;
   var cvr=document.getElementById("cvnuoc");
