...
<body>
    ...
    <form action="http://localhost/WebKhuVuiChoi/CapTreoNuHoang_admin_c/themmoi" method="post">
        <div class="header">
        ...
        <div class="container">
            <table class="content__table">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="content__table-input" name="txtMoTaCapTreo" value="">
                    </td>
                </tr>
                <tr>
                    <td>
