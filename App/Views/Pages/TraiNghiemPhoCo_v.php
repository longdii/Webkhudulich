...
<head>
    ...
    <link rel="stylesheet" href="/WebKhuVuiChoi/Public/Css/TraiNghiemPhoCo.css">
    ...
    <link rel="stylesheet" href="/Website_khu_vui_choi/Public/fonts/fontawesome-free-6.4.2-web/css/all.min.css">
            ...
            <div class="row">
                ...
                ?>
                    ...
                    <div class="content_pc_hop">
                        ...
                        <div class="content_img_pc" style="background-image: url(/WebKhuVuiChoi/Public/Images/captreo_img/<?php echo $row['AnhPhoCo']?>);" ></div>   
                    </div>
                </div>
                <?php            
                        }
