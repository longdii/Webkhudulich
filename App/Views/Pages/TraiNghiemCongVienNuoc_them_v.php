...
<body>
    <form action="http://localhost/WebKhuVuiChoi/TraiNghiemCongVienNuoc_them/themmoi" method="post">
        <div class="header">
            <ul class="header-list">
                <li class="header-item">
                    <span class="header-item-tile">
                        THÊM MỚI CÔNG VIÊN NƯỚC
                    </span>
                </li>
            </ul>
            <ul class="header-list">
        ...
        <div class="container">
            <table class="content__table">
                ...
                <tr>
                    <td>
                        <input type="file" name="txtAnhVe" require>
                    </td>
                    <td>
                        <input type="text" id="txtTentn" name="txtTentn" value="" require>
                    </td>
                    <td>
                        <input type="text" name="txtmota" value="" require>
                    </td>
                </tr>
                <tr>
                    <td>
