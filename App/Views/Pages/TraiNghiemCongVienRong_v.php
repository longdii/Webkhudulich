...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/WebKhuVuiChoi/Public/Css/TraiNghiemCongVienRong.css">
    ...
    <div class="aside">
        ...
        <div style="text-align: center" class="next-aside">
            ...
            <div id="sub-trainghiem" class="sub-trainghiem">
                ...
                <a href="http://localhost/WebKhuVuiChoi/TraiNghiemCapTreoNuHoang">+ Cáp Treo Nữ Hoàng Và Khu Đồi Huyền
                    Bí</a>
            </div>
        </diV>
    </div>
                        ...
                        <div class=" col l-4">
                            <a href="">
                                <div class="content_hop">
                                    <div class="noidung_img"><img src="http://localhost/webkhuvuichoi/Public/Images/<?php echo $row['AnhVe'] ?>">
                                    </div>
